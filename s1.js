function calculate() {
    ...
    // الاحتمالات
    let tdps = Number(document.getElementById('tdps').value) || 0;
    let exps = Number(document.getElementById('exps').value) || 0;
    document.getElementById('fps').value = ((tdps*4 + exps*6)/10).toFixed(2);
    ...
    let total = (
        ...
        (2 * document.getElementById('fps').value) +
        eng +
        eth
    ) / 19;
